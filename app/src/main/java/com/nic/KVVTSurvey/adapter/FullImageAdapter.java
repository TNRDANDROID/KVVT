...
import com.nic.KVVTSurvey.databinding.GalleryThumbnailBinding;
...
public class FullImageAdapter extends RecyclerView.Adapter<FullImageAdapter.MyViewHolder> {
    ...
    private List<KVVTSurvey> imagePreviewlistvalues;
    private final com.nic.KVVTSurvey.dataBase.dbData dbData;
    private LayoutInflater layoutInflater;

    public FullImageAdapter(Context context, List<KVVTSurvey> imagePreviewlistvalues, dbData dbData) {
