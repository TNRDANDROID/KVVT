package com.nic.KVVTSurvey.session;
...
public class PrefManager {
    ...
    private static final String KEY_SCHEME_LIST_NAME = "Scheme_Name";
    ...
    public void setKeySchemeListName(String key) {
        editor.putString(KEY_SCHEME_LIST_NAME,  key);
        editor.commit();
    }

    public String getKeySchemeListName() {
        return pref.getString(KEY_SCHEME_LIST_NAME, null);
    }
  public void setKeySchemeCode(String key) {
        editor.putString(KEY_SCHEME_CODE,  key);
        editor.commit();
    }

    public String getKeySchemeCode() {
        return pref.getString(KEY_SCHEME_CODE, null);
    }
